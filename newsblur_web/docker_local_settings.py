...
PUBSUBHUBBUB_LEASE_SECONDS = 2147483647

PRO_MINUTES_BETWEEN_FETCHES = 60
...
NEWSBLUR_URL = os.getenv("NEWSBLUR_URL", "https://newsblur_dev")

if NEWSBLUR_URL == 'https://newsblur_dev':
    SESSION_COOKIE_DOMAIN = "newsblur_dev"
